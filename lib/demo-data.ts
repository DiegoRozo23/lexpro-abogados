...
export interface Task {
  ...
  hoursLogged: number
  alerts: TaskAlert[]
  avance?: string // New field for textual progress
}
...
export const projects: Project[] = [
  ...
  { id: "p7", name: "Restructuracion Societaria", clientId: "c2", clientName: "Tecnologias Avanzadas", category: "Societario", status: "En Espera", priority: "Media", assignedTo: ["u5"], dueDate: "2026-05-15", description: "Restructuracion de la sociedad y modificacion de estatutos sociales.", avance: "Proyecto en espera. Se realizara una vez concluida la fusion corporativa. Sin avance por el momento." },
  { id: "p8", name: "Contrato Licencia de Marca", clientId: "c6", clientName: "Farmaceutica Nacional", category: "Contractual", status: "Activo", priority: "Baja", assignedTo: ["u4"], dueDate: "2026-06-01", description: "Elaboracion de contrato de licencia de uso de marca para mercados internacionales.", avance: "Investigacion de regulaciones de propiedad intelectual en mercados objetivo. Se inicio la redaccion del contrato de licencia." },
...
export const tasks: Task[] = [
  ...
  { id: "t12", title: "Redactar contrato de licencia", projectId: "p8", projectName: "Contrato Licencia de Marca", assignedTo: "u4", assignedToName: "Maria Lopez", priority: "Baja", status: "En Progreso", dueDate: "2026-04-15", description: "Elaboracion del contrato de licencia de uso de marca.", hoursLogged: 5, alerts: [{ date: "2026-04-10", time: "09:00" }] },
  { id: "t13", title: "Solicitud acuerdo conclusivo PRODECON", projectId: "p10", projectName: "Procedimiento PRODECON", assignedTo: "u4", assignedToName: "Maria Lopez", priority: "Media", status: "Pendiente", dueDate: "2026-03-15", description: "Redactar y presentar solicitud de acuerdo conclusivo.", hoursLogged: 3, alerts: [{ date: "2026-03-10", time: "09:00" }, { date: "2026-03-13", time: "10:00" }] },
  { id: "t14", title: "Analisis operaciones con proveedores", projectId: "p6", projectName: "Revision Materialidad Operaciones", assignedTo: "u3", assignedToName: "Arturo Flores", priority: "Alta", status: "En Progreso", dueDate: "2026-03-01", description: "Analisis detallado de operaciones con proveedores cuestionados.", hoursLogged: 7, alerts: [{ date: "2026-02-24", time: "09:00" }, { date: "2026-02-27", time: "09:00" }, { date: "2026-03-01", time: "08:00" }] },
]
...
export const notifications: Notification[] = [
  { id: "n1", type: "vencimiento", title: "Tarea Vencida", message: "Demanda de nulidad - Juicio Multa Ambiental ha vencido.", date: "2026-02-10", read: false, targetRole: "admin" },
  { id: "n2", type: "vencimiento", title: "Vence en 2 dias", message: "Recurso de revocacion SAT - Grupo Industrial vence el 15 Feb.", date: "2026-02-13", read: false },
  { id: "n3", type: "vencimiento", title: "Vence en 4 dias", message: "Recurso Sala Superior - Defensa Credito Fiscal vence el 17 Feb.", date: "2026-02-13", read: false },
  { id: "n4", type: "asignacion", title: "Nueva Tarea Asignada", message: "Se te ha asignado: Revision clausulas contractuales.", date: "2026-02-12", read: true, targetRole: "abogado" },
  { id: "n5", type: "recordatorio", title: "Recordatorio Semanal", message: "Tienes 7 tareas pendientes esta semana.", date: "2026-02-10", read: true, targetRole: "abogado" },
  { id: "n6", type: "recordatorio", title: "Documentación Entregada", message: "Farmaceutica Nacional ha entregado los contratos firmados del proyecto #P-2024-001.", date: "2026-02-14", read: false, targetRole: "admin" },
  { id: "n7", type: "asignacion", title: "Revision de Horas", message: "Favor de revisar las horas registradas por el equipo esta semana.", date: "2026-02-14", read: false, targetRole: "admin" },
]
